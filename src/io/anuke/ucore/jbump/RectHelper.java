...
import static io.anuke.ucore.jbump.Rect.*;
...
public class RectHelper{
	...
	public Collision rect_detectCollision(float x1, float y1, float w1, float h1, float x2, float y2, float w2, float h2, float goalX, float goalY){
